...
define( 'MTS_THEME_VERSION', '1.7.11' );
...
function mts_enqueue_css() {
    ...
    if ( empty( $mts_options['mts_header_search'] ) || '0' == $mts_options['mts_header_search'] ) {
        $mts_header_layout4 = '.header-4 #header .header-right { float: none; text-align: center; }
    ...
    $mts_header_layout5 = '';
    if( $mts_options['mts_show_primary_nav'] == 0 ) {
        $mts_header_layout5 .= '@media screen and (max-width:865px) { #site-header.header-5 { flex-direction: column; } body #site-header.header-5 .ad-navigation { display: inline-block; width: 100%; } }';
    }
        ...
        while ( $search_query->have_posts() ) : $search_query->the_post();
            ?><li>
                <a href="<?php echo esc_url( get_the_permalink() ); ?>">
                    ...
                    the_post_thumbnail( 'widgetthumb', $attr );
                    ?>
                    <?php the_title(); ?>
                    <div class="meta">
