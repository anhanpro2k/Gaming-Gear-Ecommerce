	...
	function build_frontend() {
		...
		if($collections) {
            ...
            if ($uses_google_fonts) {
                ...
                $frontend .= '<link href="' . $this->fonts_url . $this->stringify_fonts($import_fonts) .'&amp;subset='.join(',', $subsets).'&display=swap'.'" rel="stylesheet" type="text/css">';
            }
			...
			if( is_wp_error( $request ) ) {
			   ...
			   echo "Something went wrong: $error_message";
				...
				foreach ($items as $item) {
					...
					$fonts[] = array('uid' => $i, 'family' => $item['family'], 'subsets' => $item['subsets'], 'variants' => $variants, 'display' => 'swap', 'file' => $ttf);
