...
class NHP_Options_button_set extends NHP_Options {
	...
	*/
	function render(){
		...
		echo '<fieldset class="'.$class.'buttonset ui-buttonset">';
			...
			foreach( $this->field['options'] as $k => $v ){
				...
				echo '<label id="nhp-opts-button" for="'.$this->field['id'].'_'.array_search($k,array_keys($this->field['options'])).'" class="ui-button ui-state-default ui-button-text-only"><span class="ui-button-text">'.$v.'</span></label>';
