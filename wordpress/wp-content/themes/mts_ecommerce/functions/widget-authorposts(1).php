...
class mts_author_posts_widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			__('MyThemeShop: Author Posts', MTS_THEME_TEXTDOMAIN ),
			array( 'description' => __( 'Display other posts written by the author of the current post. Will appear on single posts only.', MTS_THEME_TEXTDOMAIN ) )
		);
	}
 	...
 	public function form( $instance ) {
		...
		$title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : __( 'Author Posts', MTS_THEME_TEXTDOMAIN );
