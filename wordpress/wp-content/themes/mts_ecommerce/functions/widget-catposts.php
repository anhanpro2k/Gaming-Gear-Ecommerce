...
class single_category_posts_widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			__('MyThemeShop: Category Posts', MTS_THEME_TEXTDOMAIN ),
			array( 'description' => __( 'Display the most recent posts from a single category', MTS_THEME_TEXTDOMAIN ) )
		);
	}
 	...
 	public function form( $instance ) {
		...
		$title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : __( 'Featured Category', MTS_THEME_TEXTDOMAIN );
