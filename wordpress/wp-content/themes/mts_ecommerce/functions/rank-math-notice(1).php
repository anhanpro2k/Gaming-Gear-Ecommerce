...
function rank_math_admin_notice() {
	...
	if ( ! $rm_installed ) {
			$action  = __( 'Install for FREE', MTS_THEME_TEXTDOMAIN );
			...
			$action  = __( 'Activate it now', MTS_THEME_TEXTDOMAIN );
	...
	<div class="notice rm-notice welcome-panel plugin-card-seo-by-rank-math" id="try-rankmath-panel" style="clear:both;">
		<div class="welcome-panel-content" style="overflow:hidden;">
			...
			<div style="overflow: hidden; position: relative;">
				<h2><?php esc_html_e( 'The Future of WordPress SEO is Here!', MTS_THEME_TEXTDOMAIN ); ?></h2>
				<p class="about-description"><?php echo esc_attr( 'The new Rank Math SEO plugin will help you rank better in the search results.', MTS_THEME_TEXTDOMAIN ); ?></p>
				<ul>
					<li>
						<i class="dashicons dashicons-yes"></i> <?php esc_html_e( 'Google Search Console Integration', MTS_THEME_TEXTDOMAIN ); ?>
					</li>
					<li>
						<i class="dashicons dashicons-yes"></i> <?php esc_html_e( 'Google Keyword Ranking', MTS_THEME_TEXTDOMAIN ); ?>
					</li>
					<li>
						<i class="dashicons dashicons-yes"></i> <?php esc_html_e( 'Google Keyword Suggession', MTS_THEME_TEXTDOMAIN ); ?>
					</li>
					<li>
						<i class="dashicons dashicons-yes"></i> <?php esc_html_e( 'Google ad-sense Rich Snippets', MTS_THEME_TEXTDOMAIN ); ?>
					</li>
					<li>
						<i class="dashicons dashicons-yes"></i> <?php esc_html_e( 'Advanced SEO Analysis Tool', MTS_THEME_TEXTDOMAIN ); ?>
					</li>
					<li>
						<i class="dashicons dashicons-yes"></i> <?php esc_html_e( 'Automated Image SEO', MTS_THEME_TEXTDOMAIN ); ?>
					</li>
					<li>
						<i class="dashicons dashicons-yes"></i> <?php esc_html_e( 'XML Sitemap', MTS_THEME_TEXTDOMAIN ); ?>
					</li>
					<li>
						<i class="dashicons dashicons-yes"></i> <?php esc_html_e( '404 Monitor', MTS_THEME_TEXTDOMAIN ); ?>
					</li>
					<li>
						<i class="dashicons dashicons-yes"></i> <?php esc_html_e( 'Redirection Manager', MTS_THEME_TEXTDOMAIN ); ?>
					</li>
					<li>
						<i class="dashicons dashicons-yes"></i> <?php esc_html_e( 'Local SEO Optimization', MTS_THEME_TEXTDOMAIN ); ?>
					</li>
					<li>
						<i class="dashicons dashicons-yes"></i> <?php esc_html_e( 'Lightweight', MTS_THEME_TEXTDOMAIN ); ?>
					</li>
					<li>
						<i class="dashicons dashicons-yes"></i> <?php esc_html_e( 'and much more...', MTS_THEME_TEXTDOMAIN ); ?>
					</li>
				</ul>
			...
			<a class="welcome-panel-close" id="wp_try_rankmath_panel-hide" href="<?php echo add_query_arg( 'rank_math_admin_notice_ignore', '1' ); ?>" aria-label="<?php esc_attr_e( 'Dismiss the Rank Math panel', MTS_THEME_TEXTDOMAIN ); ?>"><?php esc_html_e( 'Dismiss', MTS_THEME_TEXTDOMAIN ); ?></a>
		...
		<script type="text/javascript">
			jQuery(document).ready( function($) {
				...
				installRankmathSuccess = function( response ) {
					...
					tryRankmathPanel.find('.install-now').text('<?php echo esc_js( __( 'Activating...', MTS_THEME_TEXTDOMAIN ) ); ?>');
