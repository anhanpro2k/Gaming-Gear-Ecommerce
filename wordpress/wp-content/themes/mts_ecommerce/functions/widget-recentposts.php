...
class mts_recent_posts_widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			__('MyThemeShop: Recent Posts', MTS_THEME_TEXTDOMAIN ),
			array( 'description' => __( 'Display the most recent posts from all categories', MTS_THEME_TEXTDOMAIN ) )
		);
	}
 	...
 	public function form( $instance ) {
		...
		$title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : __( 'Recent Posts', MTS_THEME_TEXTDOMAIN );
